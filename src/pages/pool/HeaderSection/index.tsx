  ...
  return (
    <div className="pt-4 w-auto mb-10">
      <div
        ...
        "
      >
        <img src="/static/pool_banner.png" className="block w-48 mb-10 md:absolute md:right-16 md:top-4 md:w-72" alt="" />
        <div className="flex flex-col">
          ...
          <NavLink to="/voting/create">
            <Button type="primary" className="min-w-30 h-10 text-sm font-medium rounded text-light-black">
              {t('pool_btn_text')}
            </Button>
          </NavLink>
        </div>
