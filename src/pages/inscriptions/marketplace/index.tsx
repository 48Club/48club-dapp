        ...
        <div className="w-full -mt-[60px]">
            <Row gutter={[24, 24]}>
                <Col span={24} md={{span: 8}}>
                    <div className="w-full md:hover:border-[#FFC801] border-[2px] border-transparent transition-colors cursor-pointer flex items-center px-[14px] py-[24px] bg-[white] party-item h-[100px]">
                        <img className="w-[42px] h-[42px]" src="https://" alt="" />
