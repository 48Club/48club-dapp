...
export const TOKENS: PropsOrUndefined = {
  [ChainId.BSC]: {
    '0xe543f1A2412eaCfBF00C2F633A62369E3F4BFD8F': 'Pancake KOGE/USDT V2 LP',
...
export const STAKING_WHITELIST: string[] | undefined = {
  [ChainId.BSC]: [
    '0xe543f1A2412eaCfBF00C2F633A62369E3F4BFD8F',
    '0xe6DF05CE8C8301223373CF5B969AFCb1498c5528',
    '0x26De6C26DD5560C181011907d8F70C202C2a29D6',
    '0xB0836DD99e3A68d70c593530548C982Ab7B95a4a',
  ],
  [ChainId.BSCTestnet]: [
